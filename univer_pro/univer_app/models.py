...
class Numberstudents(models.Model):
    number = models.CharField(max_length=15, unique=True)  # Админ добавляет номера студентов
...
class Documentation(models.Model):  # Документы, необходимые для поступления:
    title = models.CharField(max_length=100)
